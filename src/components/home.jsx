...
const Home = () => {
  return (
    ...
    <Container maxWidth={'container.xl' } minHeight={'100vh'} p='16' marginTop={['00','100']}>
    <Heading textTransform={'uppercase'} py='2' w={'fit-content'} borderBottom={'2px solid'} margin={'auto'}>Services</Heading>
    <Stack h={'full'} direction={['column']} p={'4'} alignItems={'center'} justifyContent={'space-evenly'} zIndex={'overlay'}>
...
const Mycarousel = () => {
  return (
        ...
        <Carousel   autoplay  infiniteLoop interval={3000} showStatus={false} showArrows={false} showIndicators ={true} swipeScrollTolerance={false} preventMovementUntilSwipeScrollTolerance="false" >
